...
const menuItems: MenuItem[] = [
  {
    ...
    label: "Home",
    href: "https://home.firetime.world",
  ...
  },
  {
    ...
    label: "Youtube",
    href: "https://www.youtube.com/@FireTime.official",
    gradient: "radial-gradient(circle, rgba(249,115,22,0.15) 0%, rgba(234,88,12,0.06) 50%, rgba(194,65,12,0) 100%)",
    iconColor: "text-orange-500",
  },
  {
    ...
    label: "Twitch",
    href: "https://twitch.tv/firetimeofficial",
    gradient: "radial-gradient(circle, rgba(249,115,22,0.15) 0%, rgba(234,88,12,0.06) 50%, rgba(194,65,12,0) 100%)",
    iconColor: "text-orange-500",
  },
  {
  ...
  },
  {
    ...
    label: "More",
    href: "https://firetime.me/blog/too-many-sites/",
    gradient: "radial-gradient(circle, rgba(249,115,22,0.15) 0%, rgba(234,88,12,0.06) 50%, rgba(194,65,12,0) 100%)",
    iconColor: "text-orange-500",
  }
